...
--
-- Table structure for table `burn_parameters`
--

DROP TABLE IF EXISTS `burn_parameters`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `burn_parameters` (
...
--
-- Dumping data for table `burn_parameters`
--

LOCK TABLES `burn_parameters` WRITE;
/*!40000 ALTER TABLE `burn_parameters` DISABLE KEYS */;
INSERT INTO `burn_parameters` VALUES (16,'Rohde Ecotop123',12,2,'asdf',200,'S',3,2,'DS1820',23,2,3,4,0,24,25,8,10,26,5,17,'c',10000,1,10,0,10,1,1,10,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'HIGH_OPEN',1,3),(1,'Rohde TE-MCC+12345',80,52,'Attefall',5000,'K',15,18,'DS1820',NULL,NULL,NULL,NULL,NULL,NULL,24,NULL,2,25,14,202,'c',1500,1,5,0,10,0,0,15,0,25,500,5000,5450,0.5,0.05,0.1,0.05,1,'$',10,NULL,1,6),(1,'Rohde TE-MCC+12345',80,52,'Attefall',5000,'K',15,18,'DS1820',NULL,NULL,NULL,NULL,NULL,NULL,24,NULL,2,25,14,202,'c',1500,1,5,0,10,0,0,15,0,25,500,5000,5450,0.5,0.05,0.1,0.05,1,'$',10,NULL,19,7),(16,'Rohde Ecotop123',12,2,'asdf',200,'S',3,2,'DS1820',23,2,3,4,0,24,25,8,10,26,5,17,'c',10000,1,10,0,10,1,1,10,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'HIGH_OPEN',1,8),(16,'Rohde Ecotop123',12,2,'asdf',200,'S',3,2,'DS1820',23,2,3,4,0,24,25,8,2,26,5,17,'c',10000,1,10,0,10,1,1,10,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'HIGH_OPEN',1,9);
/*!40000 ALTER TABLE `burn_parameters` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-03-02 19:34:33
